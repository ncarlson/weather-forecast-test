...
```json
{
  ...
  "projectName" : "my-weatherforecast-csharp"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'my_sample_app'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->my-sample-app]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'my-sample-app.csproj'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app->my-weatherforecast-c...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->my_sample_app]
